...
rules.add_perm("portal.add_businessmembership", is_integration_admin)
rules.add_perm("portal.change_businessmembership", is_integration_admin)
rules.add_perm("portal.view_businessmembership", is_integration_admin)
rules.add_perm("portal.delete_businessmembership", is_integration_admin)
